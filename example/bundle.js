...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (t, e) {
	  ...
	  return function (t) {
	    ...
	    }Object.defineProperty(e, "__esModule", { value: !0 });var p = r(2),
	        i = a(p);e["default"] = i["default"];
	  }, function (t, e, r) {
	    "use strict";
	    function a(t) {
	      return t && t.__esModule ? t : { "default": t };
	    }Object.defineProperty(e, "__esModule", { value: !0 });var p = Object.assign || function (t) {
	      for (var e = 1; e < arguments.length; e++) {
	        var r = arguments[e];for (var a in r) {
	        ...
	        u = a(l),
	        g = r(5),
	        f = a(g);e["default"] = o["default"].createClass({ displayName: "graph", mixins: [f["default"]], getDefaultProps: function getDefaultProps() {
	        return { graphType: "bar", data: [], maxValue: null, width: 400, height: 200, leftPadding: 35, topPadding: 5, rightPadding: 5, bottomPadding: 20, animationRenderInterval: 50 };
	      }, getInitialState: function getInitialState() {
	        return { maxValue: this.props.maxValue || Math.max.apply(null, this.props.data.map(function (t) {
	            return t.value;
	          })), oldMaxValue: this.props.maxValue || Math.max.apply(null, this.props.data.map(function (t) {
	            return t.value;
	          })), percentHeight: 0, oldData: this.props.data, graphWidth: this.props.width - this.props.leftPadding - this.props.rightPadding, graphHeight: this.props.height - this.props.topPadding - this.props.bottomPadding };
	      }, componentDidMount: function componentDidMount() {
	        this.timer();
	      }, componentWillReceiveProps: function componentWillReceiveProps(t) {
	        this.isMounted() && this.setState({ maxValue: t.maxValue || Math.max.apply(null, t.data.map(function (t) {
	            return t.value;
	          })), oldMaxValue: this.state.maxValue, percentHeight: 0, graphWidth: this.props.width - this.props.leftPadding - this.props.rightPadding, graphHeight: this.props.height - this.props.topPadding - this.props.bottomPadding }, this.timer);
	      }, timer: function c() {
	        var t = this,
	            c = setInterval(function () {
	          t.isMounted() ? t.state.percentHeight < 1 ? t.setState({ percentHeight: parseFloat((t.state.percentHeight + .1).toPrecision(2)) }) : (clearInterval(c), t.setState({ oldData: t.props.data, oldMaxValue: t.props.maxValue || Math.max.apply(null, t.props.data.map(function (t) {
	              return t.value;
	            })) })) : clearInterval(c);
	        }, this.props.animationRenderInterval || 50);
	      }, render: function render() {
	        return o["default"].createElement("svg", { width: this.props.width, height: this.props.height }, o["default"].createElement("g", { transform: "translate(" + this.props.leftPadding + "," + this.props.topPadding + ")" }, "bar" === this.props.graphType && o["default"].createElement(n["default"], p({}, this.props, this.state)), "line" === this.props.graphType && o["default"].createElement(h["default"], p({}, this.props, this.state))), o["default"].createElement(u["default"], p({}, this.props, this.state)));
	      } });
	  }, function (e, r) {
	    e.exports = t;
	  }, function (t, e, r) {
	    ...
	    function a(t) {
	      return t && t.__esModule ? t : { "default": t };
	    }Object.defineProperty(e, "__esModule", { value: !0 });var p = r(3),
	        i = a(p),
	        o = r(5),
	        s = a(o);e["default"] = i["default"].createClass({ displayName: "bar-graph", mixins: [s["default"]], getDefaultProps: function getDefaultProps() {
	        return { graphWidth: 0, graphHeight: 0, maxValue: 0, oldMaxValue: 0, data: [], oldData: [], percentHeight: 0 };
	      }, render: function render() {
	        var t = this;return i["default"].createElement("g", null, this.props.data.map(function (e, r) {
	          var a = t.props.data[r].value / t.props.maxValue * t.props.graphHeight;isNaN(a) && (a = 0);var p = t.props.oldData && t.props.oldData[r] ? t.props.oldData[r].value : void 0;p = p ? p / t.props.oldMaxValue * t.props.graphHeight : 0;var o = a >= p ? p + (a - p) * t.props.percentHeight : p - (p - a) * t.props.percentHeight;return 0 > o && (o = 0), 2 > o && e > 0 && (o = 2), i["default"].createElement("rect", { width: t.props.graphWidth > 0 ? t.props.graphWidth / t.props.data.length - 2 : 0, height: o, fill: "steelblue", x: r * (t.props.graphWidth / t.props.data.length) + 1, y: t.props.graphHeight - o, key: "bar-graph-bar-" + r });
	        }));
	      } });
	  }, function (t, e, r) {
	    t.exports = r(6);
	    ...
	    "use strict";
	    var a = r(7),
	        p = { shouldComponentUpdate: function shouldComponentUpdate(t, e) {
	        return a(this, t, e);
	      } };t.exports = p;
	  }, function (t, e, r) {
	    "use strict";
	    function a(t, e, r) {
	      return !p(t.props, e) || !p(t.state, r);
	    }var p = r(8);t.exports = a;
	  }, function (t, e) {
	    "use strict";
	    function r(t, e) {
	      return t === e ? 0 !== t || 1 / t === 1 / e : t !== t && e !== e;
	    }function a(t, e) {
	      if (r(t, e)) return !0;if ("object" != (typeof t === "undefined" ? "undefined" : _typeof(t)) || null === t || "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) || null === e) return !1;var a = Object.keys(t),
	          i = Object.keys(e);if (a.length !== i.length) return !1;for (var o = 0; o < a.length; o++) {
	        if (!p.call(e, a[o]) || !r(t[a[o]], e[a[o]])) return !1;
	      }return !0;
	    }var p = Object.prototype.hasOwnProperty;t.exports = a;
	  }, function (t, e, r) {
	    "use strict";
	    function a(t) {
	      return t && t.__esModule ? t : { "default": t };
	        ...
	        i = a(p),
	        o = r(5),
	        s = a(o);e["default"] = i["default"].createClass({ displayName: "line-graph", mixins: [s["default"]], getDefaultProps: function getDefaultProps() {
	        return { graphWidth: 0, graphHeight: 0, maxValue: 0, oldMaxValue: 0, data: [], oldData: [], percentHeight: 0 };
	      }, render: function render() {
	        var t = this,
	            e = this.props.data.map(function (e, r) {
	          var a = t.props.data[r].value / t.props.maxValue * t.props.graphHeight;isNaN(a) && (a = 0);var p = t.props.oldData && t.props.oldData[r] ? t.props.oldData[r].value : void 0;p = p ? p / t.props.oldMaxValue * t.props.graphHeight : 0;var i = a >= p ? p + (a - p) * t.props.percentHeight : p - (p - a) * t.props.percentHeight;return 0 > i && (i = 0), { x: r * (t.props.graphWidth / t.props.data.length), y: t.props.graphHeight - i };
	        }),
	            r = "M0," + this.props.graphHeight + "L";return e.forEach(function (t) {
	          r += t.x + "," + t.y + "L";
	        }), r += this.props.graphWidth + "," + this.props.graphHeight + "Z", i["default"].createElement("path", { className: "", d: r, stroke: "rgb(70,130,180)", strokeWidth: "2", fill: "rgb(70,130,180)", fillOpacity: "0.3" });
	      } });
	  }, function (t, e, r) {
	    "use strict";
	    function a(t) {
